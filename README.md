...
Para dar vida à interface e construir uma identidade visual própria e harmônica, foram utilizadas as seguintes tecnologias:
* **HTML5:** Estruturação semântica de todo o conteúdo textual e caixas de informações (cards).
...
* **Qualidade do Código:** Todo o código fonte (HTML, CSS e JS) está **perfeitamente indentado**, facilitando a leitura técnica.
